...
namespace Ajax.Example.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [OutputCache(Duration = 3, Location = System.Web.UI.OutputCacheLocation.Client)]
        ...
        {
            var result = db.Students.Where(x => x.FirstName == "a");
            return PartialView("_FirstName", result);
        }

        public ActionResult GetB()
        {
            var result = db.Students.Where(x => x.FirstName == "b");
            return PartialView("_FirstName", result);
        }
